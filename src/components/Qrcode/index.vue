            ...
            <div class="code">
				...
				<div v-if="isShowCode" style="position: relative;width: 100%;height: 32rem;">
					...
					<div style="position: absolute;top: 0;z-index: 4;width:100%;padding: 0.9375rem;">
						...
						<div v-if="index==2" style="width: 15.25rem;margin: 0.4375rem auto;font-size: 1rem;font-weight: 400;text-align: left;color: #ffffff;line-height: 1.5rem;height: 5.6rem;">您好！为了您的健康安全和疫情防控需要，请您实行居家隔离医学观察。</div>
						<div v-if="index==3" style="width: 15.25rem;margin: 0.4375rem auto;font-size: 1rem;font-weight: 400;text-align: left;color: #ffffff;line-height: 1.5rem;height: 5.6rem;">您好！为了您的健康安全和疫情防控需要，请您到指定的集中隔离医学观察点，实行集中隔离。</div>
