        ...
        <div class="code-content">
            <div class="code">
				...
				<div v-if="isShowCode" style="position: relative;width: 100%;height: 32rem;">
					<img style="position: absolute;z-index: 3;top: 0;left: 0;height: 13.9rem;" v-if="this.index==1" src="./image/codebg1.png" alt=""/>
					<img style="position: absolute;z-index: 3;top: 0;left: 0;height: 13.9rem;" v-if="this.index==2" src="./image/codebg2.png" alt=""/>
					<img style="position: absolute;z-index: 3;top: 0;left: 0;height: 13.9rem;" v-if="this.index==3" src="./image/codebg3.png" alt=""/>
					<div style="position: absolute;top: 0;z-index: 4;width:100%;padding: 0.9375rem;">
						<div style="font-size: 1.5rem;margin-top: 0.9375rem;font-weight: 600;text-align: center;color: #ffffff;line-height: 2.0625rem;letter-spacing: 0.125rem;">健康状态：正常</div>
						<div style="width: 100%;font-size: 1rem;margin-top: 0.9375rem;font-weight: 400;text-align: center;color: #ffffff;line-height: 1.375rem;letter-spacing: 0.0625rem;">王易</div>
					...
					<div style="margin: 0.9375rem 0.625rem 0 0.625rem;background-color: #F6F6F9;padding: 0.625rem 0.75rem;">
						<div style="overflow: auto;zoom: 1;">
							...
							<div style="float: right;font-size: 15px;font-weight: 400;color: #292a2c;line-height: 1.375rem;">张涛</div>
						</div>
						<div style="overflow: auto;zoom: 1;margin-top: 0.2rem;">
							<div style="float: left;font-size: 15px;font-weight: 300;color: #595b64;line-height: 1.375rem;">身份</div>
							<div style="float: right;font-size: 15px;font-weight: 400;color: #292a2c;line-height: 1.375rem;">联通旅游行业总监</div>
						</div>
					</div>
    ...
    export default {
        ...
        methods:{
			getHealthCode(){
				...
				journeyAPI.healthCode({phone:user.phoneNo,userId:user.id}).then(res => {
                    console.log(res)
                })
			},
            click() {
